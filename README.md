# Hello AdventAI - Day 1️⃣2️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d12&owner=%40me&name=th-adventai-d12&description=AdventAI+Day+12+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 1️⃣2️⃣](#hello-adventai---day-1️⃣2️⃣)
...
![Screengrab](repository-assets/estate_screen.gif)

On Day ️1️⃣2️⃣, we are unwrapping a Real Estate bot, which leverages the `web-search` tool to recommend properties that fit your needs. Hunting good ones is time consuming, and if you aren't fast enough, someone else might pick your dream home, so the app also sends daily email notifications with relevant fits!

What the app does:

- **Property/Real Estate Search**: Looks for real estate that fit your requirements and shares essentials like posting URLs, descriptions and so on.
- **Email Notifications**: Sends the aforementioned recommendations daily, right in your inbox.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d12&owner=%40me&name=th-adventai-d12&description=AdventAI+Day+12+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d12&owner=%40me&name=th-project&description=AdventAI+Day+12+Fork&visibility=public)
...
```bash
git clone https://github.com/{USERNAME}/adventai-d12/
cd adventai-d12
```
...
[Back to Top ⬆️](#hello-adventai---day-1️⃣2️⃣)
